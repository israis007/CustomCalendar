...
import com.irisoft.calendarmodule.ui.utils.DayRange
...
class DayView @JvmOverloads constructor(
    ...
    private val scrollView: ClockScrollView
    ...
    init {
        ...
        addView(dividerView,
            LayoutParams(
                LayoutParams.MATCH_PARENT,
                dividerView.background.intrinsicHeight
            )
        )
        ...
        val daysWrapper = LinearLayout(context).apply {
            clipChildren = false
            addView(eventView, LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT))
        }
        scrollView = ClockScrollView(context).apply {
