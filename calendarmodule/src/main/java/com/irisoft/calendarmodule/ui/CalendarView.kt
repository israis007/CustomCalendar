...
import com.irisoft.calendarmodule.ui.pager.InfinitePagerAdapter
import com.irisoft.calendarmodule.ui.utils.*
import kotlinx.android.synthetic.main.main_calendar.view.*
...
class CalendarView @JvmOverloads constructor(
    ...
    init {
        View.inflate(context, R.layout.main_calendar, this)
        ...
        pagerAdapter = object : InfinitePagerAdapter<Day, RangeView>(visibleStart, 2) {
            ...
            override fun instantiateItem(indicator: Day, oldView: RangeView?): RangeView {
                ...
                val view = (oldView as? DayView) ?: DayView(context, day = indicator)
        ...
        pager.listener = object : OnInfinitePageChangeListener {
    ...
    private fun onRangeUpdated() {
        ...
        startIndicator = RangeHeaderView(context, _range = visibleStart.range(1))
