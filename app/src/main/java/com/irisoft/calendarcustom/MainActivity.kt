package com.irisoft.calendarcustom
...
import com.irisoft.calendarcustom.databinding.ActivityMainBinding
import com.irisoft.calendarmodule.ui.BaseEvent
import com.irisoft.calendarmodule.ui.Event
import com.irisoft.calendarmodule.ui.utils.Day
import com.irisoft.calendarmodule.ui.utils.Week
    ...
    private fun populate(week: Week, force: Boolean = false) {
        ...
        for (i in 0..15) {
            ...
            events.add(
                ...
                start,
                start + abs(random.nextLong()) % (DateUtils.DAY_IN_MILLIS / 8), false)
            )
        }
        for (i in 0..3) {
            val id = nextId++.toString()
